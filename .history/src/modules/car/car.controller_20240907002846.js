...
export const createCar = async (req, res) => {
    const {name, brand, model, pricePerDay, availability } = req.body;
    ...
    const car = new carModel({name, brand, model, pricePerDay, availability ,  customId , image:{secure_url , public_id} , coverImages:list  });
...
export const updateCar = async (req, res) => {
    ...
    if (car) {
        car.brannamd = req.body.brand || car.brand;
