...
carRouter.post('/',  multerHost(validExtensions.image).fields([{name : "image" , maxCount : 1} , {name:"coverImages" , maxCount : 3} ]) ,validation(CV.createValidation), auth(["admin"]), auth(['admin']), CC.createCar);
