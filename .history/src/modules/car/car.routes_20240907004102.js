...
carRouter.post('/',  multerHost(validExtensions.image).fields([{name : "image" , maxCount : 1} , {name:"coverImages" , maxCount : 3} ]) ,validation(PV.createProductValidation), auth(["admin"]), auth(['admin']), CC.createCar);
