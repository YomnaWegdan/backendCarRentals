...
carRouter.put('/:id', multerHost(validExtensions.image).fields([{name : "image" , maxCount : 1} , {name:"coverImages" , maxCount : 3} ]) , ,validation(CV.createCarValidation), auth(["admin"]) auth(['admin']), CC.updateCar);
